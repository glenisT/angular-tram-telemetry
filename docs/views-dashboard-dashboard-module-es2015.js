...
class AnalyticsComponent {
    constructor(themeService, data) {
        ...
        this.gaugeMarkers = { "50": { color: "#555", type: "triangle", size: 8, label: "Goal", font: "12px arial" } };
        this.gaugeSize = 600;
            ...
            while (true) {
                for (let i = 0; i <= 0; i++) {
                    if (this.message == 50) {
                        ...
                        yield this.sleep(13000); //wait 9seconds before slowing down
                        this.message = 0;
                        yield this.sleep(12000); //wait 12seconds at station
                    }
                    yield this.sleep(100); //increment speed every 0.1s because 5s/50km = 0.1s/km (formula is maximumSpeed/maximumSpeedReachedInterval = incrementInterval)
...
AnalyticsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AnalyticsComponent, selectors: [["app-analytics"]], decls: 73, vars: 71, consts: [["id", "graph-container", 1, "mat-bg-primary", "mx--033", "mt--033", "px-24", "pt-24", "pb-96"], [1, "text-white", "font-weight-normal"], [1, "extragrid"], [1, "row1"], [1, "ngx-gauge-ppm"], [2, "display", "flex", "margin-left", "30%"], [1, "text-white", "font-weight-bold"], [1, "mat-icon", 2, "position", "inherit", "margin-left", "17%", "padding-top", "15%"], [2, "margin-top", "-12%", 3, "type", "value", "min", "max", "label", "append", "thick", "foregroundColor", "backgroundColor", "size", "duration"], [1, "ngx-gauge-temp"], [2, "display", "flex", "margin-left", "16%"], [1, "text-white", "font-weight-bold", 2, "white-space", "nowrap"], [1, "mat-icon", 2, "position", "inherit", "margin-left", "10%", "padding-top", "15%"], [2, "margin-top", "-15%", 3, "type", "value", "min", "max", "label", "append", "thick", "foregroundColor", "backgroundColor", "size", "duration"], [1, "ngx-gauge-pmv"], [2, "display", "flex", "margin-left", "25%"], [2, "margin-top", "-12.5%", 3, "type", "value", "min", "max", "label", "append", "thick", "foregroundColor", "backgroundColor", "size", "duration"], [1, "row2"], [2, "text-align", "center", "padding-bottom", "10px"], ["src", "assets/images/backgrounds/treno-colorato.png", "alt", "schema", 1, "schema-train"], [1, "ngx-gauge"], [2, "display", "flex", "margin-left", "33%"], [1, "mat-icon", 2, "position", "absolute", "left", "85%", "top", "15%"], [3, "type", "value", "max", "label", "append", "thick", "foregroundColor", "backgroundColor", "size"], [1, "mt--72"], ["fxLayout", "row wrap"], ["fxFlex", "100", "fxFlex.sm", "100", "fxFlex.gt-sm", "100"], ["fxFlex", "100", "fxFlex.sm", "90", "fxFlex.gt-sm", "90"], ["fxFlex", "", "fxLayout", "row", "fxLayoutAlign", "space-between center", 1, "p-40"], ["fxLayout", "row", "fxLayoutAlign", "center center"], [1, "ml-12"], [1, "m-0", "text-muted", "mb-4"]], template: function AnalyticsComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](24, "Umidit\u00E0 interna");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](36, "Velocit\u00E0 attuale");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony import */ var app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/shared/shared-material.module */ "./src/app/shared/shared-material.module.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DashboardModule, { declarations: [_analytics_analytics_component__WEBPACK_IMPORTED_MODULE_10__["AnalyticsComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        app_shared_shared_material_module__WEBPACK_IMPORTED_MODULE_0__["SharedMaterialModule"],
        _angular_flex_layout__WEBPACK_IMPORTED_MODULE_4__["FlexLayoutModule"],
        ng2_charts__WEBPACK_IMPORTED_MODULE_5__["ChartsModule"],
        ngx_echarts__WEBPACK_IMPORTED_MODULE_6__["NgxEchartsModule"],
        ...
        app_shared_pipes_shared_pipes_module__WEBPACK_IMPORTED_MODULE_8__["SharedPipesModule"],
        ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_11__["PerfectScrollbarModule"],
        ngx_gauge__WEBPACK_IMPORTED_MODULE_12__["NgxGaugeModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"]] }); })();
